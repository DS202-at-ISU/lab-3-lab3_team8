...
returns <- av %>%
  ...
  pivot_longer(cols = everything(), names_to = "Time", values_to = "Return") %>%
  mutate(Time = parse_number(Time),
         Return = ifelse(Return == "YES", "yes", "no"))
